...
public class SuperRent implements LoginWindowDelegate, MainTerminalTransactionsDelegate {
    ...
    public void showAvailableVehicles(String location, Timestamp startDateTime, Timestamp endDateTime, String carType) throws SQLException {
    ...
    public void reserveVehicle(String carType, String dLicense, Timestamp startDateTime, Timestamp endDateTime, String location) throws SQLException {
    ...
    public void returnVehicle(int rid, Timestamp returnDateTime, int odometerReading, boolean isTankFull) throws SQLException {
        ReturnModel model;
        try{
